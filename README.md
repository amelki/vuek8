...
| Platform | Download |
|----------|----------|
| **macOS (Apple Silicon)** | [Vue.k8-0.4.6.dmg](https://github.com/amelki/vuek8/releases/latest/download/Vue.k8-0.4.6.dmg) |
| **macOS (Intel)** | [vuek8-0.4.6-macos-amd64](https://github.com/amelki/vuek8/releases/latest/download/vuek8-0.4.6-macos-amd64) |
| **Linux** | [vuek8-0.4.6-linux-amd64](https://github.com/amelki/vuek8/releases/latest/download/vuek8-0.4.6-linux-amd64) |
| **Windows** | [vuek8-0.4.6-windows-amd64.exe](https://github.com/amelki/vuek8/releases/latest/download/vuek8-0.4.6-windows-amd64.exe) |
